...
const AquaFormContainer = styled(Box)(({ theme }) => ({
    ...
    padding: theme.spacing(6), // Significantly increased internal padding
    display: 'flex',
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                if (!success) {
                    // AuthContext's login function now handles toast notifications internally
                    // and returns true/false. If false, it means login failed.
